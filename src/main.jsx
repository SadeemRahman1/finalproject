...
const router = createBrowserRouter([
  ...
  { path: '/f-staff', element: <FinanceList /> },
  { path: '/department', element: <DepartmentList /> },
  { path: '/profile', element: <Setting /> },
  { path: '/addStudent', element: <AddStudent /> },
  { path: '/addFaculity', element: <AddFaculity /> },
  { path: '/addFinance', element: <AddFinanceModal /> },
  { path: '/addDepartment', element: <AddDepartmentModal /> },
  { path: '/studentdashboard', element: <StudentDashboard /> },
  { path: '/studentcourses', element: <Student_Courses /> },
  { path: '/studentassignments', element: <Student_Assignments /> },
  { path: '/studentschedule', element: <Student_Schedule /> },
  { path: '/studentannouncements', element: <Student_Announcements /> },
]);
