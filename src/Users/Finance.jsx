...
import { getFinanceUsers, deleteFinanceUser } from "../Services/admin";
import EditFinanceModal from '../Register/Modal/EditFinance';
...
function FinanceList() {
    ...
    const handleDeleteConfirm = () => {
        try {
            deleteFinanceUser(selectedStudent.email);
                ...
                <header className="mb-6 flex items-center justify-between">
                    ...
                    <div className="flex space-x-4">
                        <button className="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300 transition"
                            ...
                            + Add New Finance Staff
                        </button>
                    </div>
                </header>
                <section>
                    <h2 className="text-xl font-semibold text-gray-700 mb-4">Finance Staff List</h2>
                    <div className="space-y-4">
                        {faculty.length === 0 ? (
                            <p className="text-gray-500">No finance staff found</p>
                        ) : (
                            faculty.map((student, index) => (
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-4 gap-3 items-center">
                                        ...
                                        <div className="text-gray-600">{student.password}</div>
